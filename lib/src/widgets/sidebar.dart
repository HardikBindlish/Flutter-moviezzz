...
import 'package:moviezzz/src/screens/home_screen_seasons.dart';
import 'package:moviezzz/src/widgets/drop_down_genre.dart';
        ...
        children: <Widget>[
                    ...
                    Row(
                      children: <Widget>[
                        Padding(
                          ...
                          child: Text('Movies', style: TextStyle(fontSize: 16.0),),
                        )
                      ],
                    ),
                    Icon(Icons.movie)
          ...
          Container(
            ...
            child: InkWell(
              onTap: (){
                Navigator.push(context, MaterialPageRoute(
                  builder: (context) => HomeScreenSeasons()
                ));
              },
              child: Padding(
                padding: const EdgeInsets.symmetric(horizontal: 8.0),
                  ...
                  children: <Widget>[
                    Row(
                      children: <Widget>[
                        Padding(
                          padding: const EdgeInsets.all(8.0),
                          child: Text('Seasons', style: TextStyle(fontSize: 16.0),),
                        )
                      ],
                    ),
          ...
          Container(
            ...
            child: StreamBuilder(
                  ...
                  return ExpansionTile(
                        title: Text('Genre', style: TextStyle(fontSize: 16.0),),
                        children: <Widget>[
                          ListView.builder(
