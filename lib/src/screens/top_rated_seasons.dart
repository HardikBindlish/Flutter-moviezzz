...
class TopRatedSeasons extends StatefulWidget {
  @override
  _TopSeasonsState createState() => _TopSeasonsState();
}

class _TopSeasonsState extends State<TopRatedSeasons> {
  void initState() {
